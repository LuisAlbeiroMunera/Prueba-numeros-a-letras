...
public String Convertir(String numero) {
    ...
    if (Pattern.matches("\\d{1,12},\\d{1,2}", numero)) {
        ...
        if (d!="") {
            String etiquetaEnteroSingular="";
        	if (etiquetaEnteroSingular !="") parte_decimal += " ";
        	if (Integer.parseInt(Num[1])==1) {
                String etiquetaConector = "con";
                String etiquetaFlotanteSingular = "con";
        		parte_decimal += etiquetaConector + " " + d + etiquetaFlotanteSingular;
        	} else {
                String etiquetaConector = "con";
                String etiquetaFlotantePlural = "centavos";
        ...
        if (mayusculas) {
            ...
            return (literal + parte_decimal + " peoso");
        }
...
private String getMilesMillones(String numero) { //000 000 000 000        
    ...
    String n = "";
    if (Integer.parseInt(millon) == 1) {
    	n = getUnidades(millon) + "mil ";
    } else {
    	n = getCentenas(millon) + "mil ";
    }
    ...
    public static void main(String[] args) {
      Prueba p = new Prueba();
	System.out.println("Hola!!! Prueba repositorio"); 
